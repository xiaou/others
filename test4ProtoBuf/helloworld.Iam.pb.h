...
// required string username = 2;
inline bool Iam::has_username() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void Iam::set_has_username() {
  _has_bits_[0] |= 0x00000002u;
}
inline void Iam::clear_has_username() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void Iam::clear_username() {
  if (username_ != &::google::protobuf::internal::kEmptyString) {
    username_->clear();
  }
  clear_has_username();
}
inline const ::std::string& Iam::username() const {
  return *username_;
}
inline void Iam::set_username(const ::std::string& value) {
  set_has_username();
  if (username_ == &::google::protobuf::internal::kEmptyString) {
...
inline void Iam::set_username(const char* value) {
  set_has_username();
  if (username_ == &::google::protobuf::internal::kEmptyString) {
    username_ = new ::std::string;
  }
...
inline void Iam::set_username(const char* value, size_t size) {
  set_has_username();
  if (username_ == &::google::protobuf::internal::kEmptyString) {
    username_ = new ::std::string;
  }
...
inline ::std::string* Iam::mutable_username() {
  set_has_username();
  if (username_ == &::google::protobuf::internal::kEmptyString) {
    username_ = new ::std::string;
  }
...
inline ::std::string* Iam::release_username() {
  clear_has_username();
  if (username_ == &::google::protobuf::internal::kEmptyString) {
    return NULL;
  } else {
